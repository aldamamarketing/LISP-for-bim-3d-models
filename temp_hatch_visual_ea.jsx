...
export default function HatchVisualEditor({ code, initialScale = 1, onSave, onCancel }) {
  ...
  useEffect(() => {
    ...
    for (const def of defs) {
      ...
      // No soportamos dashes perfectos en Canvas r├ípido, dibujamos s├│lido por ahora
    ...
    // Dibujar el ├írea punteada de recorte (Viewport fijo en el centro)
    const cropSize = 256;
    ...
    // Oscurecer lo que est├í fuera del recorte
