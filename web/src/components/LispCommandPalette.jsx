...
export default function LispCommandPalette() {
  ...
  const { filteredCmds, sortedGroups, grouped } = useMemo(() => {
    ...
    const filtered = commands.filter(cmd => {
      ...
      return normalizedFilters.some(tag => searchableText.includes(tag));
    });
    ...
    return { filteredCmds: filtered, sortedGroups: sortedKeys, grouped: groupsMap };
  }, [commands, activeFilters]);

  return (
    <div data-build-hash="2026-v2" style={{ backgroundColor: '#181818', color: '#fff', height: '100vh', overflow: 'hidden', fontFamily: "'Inter', sans-serif", display: 'flex', flexDirection: 'column' }}>
