...
export default function LispCommandPalette() {
  ...
  // Filter, group and sort with memoization for performance
  const { filteredCmds, grouped, sortedGroups } = useMemo(() => {
    ...
    const sortedGrp = Object.keys(grp).sort((a, b) => {
    ...
    return { filteredCmds: filtered, grouped: grp, sortedGroups: sortedGrp };
