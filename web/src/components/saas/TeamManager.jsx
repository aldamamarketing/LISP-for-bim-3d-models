      ...
      <div className="bg-gray-800 p-6 rounded-lg text-white border border-gray-700 shadow-xl">
        ...
        {!team ? (
          <div className="text-center p-12 bg-gray-900 rounded-lg border border-gray-700 mt-4">
            ...
            <h3 className="text-xl font-bold mb-2">Centralize your Team's Standards</h3>
            <p className="mb-6 text-gray-400 max-w-md mx-auto">Create a private corporate environment to ensure all your drafters work under the same layer and style standards.</p>
            <button 
