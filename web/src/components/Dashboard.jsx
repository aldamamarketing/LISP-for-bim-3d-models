  ...
  return (
    <div className="flex min-h-screen bg-background text-white font-body-md flex-col md:flex-row">
      ...
      <div className="md:hidden bg-[#0D0D0D] border-b border-[#262626] p-4 flex justify-between items-center z-30 sticky top-0">
        ...
        <button onClick={() => setIsMobileMenuOpen(!isMobileMenuOpen)} className="text-white" aria-label="Abrir menu">
            ...
            {draftLisps.map((draft, i) => (
              <tr key={'draft-'+i} className="border-b border-[#262626] bg-primary-container/5 hover:bg-[#1a1c1c] transition-colors group">
                ...
                <td className="py-4 pr-4 text-right">
                  ...
                  <button className="text-on-secondary-container hover:text-error transition-colors" onClick={() => removeDraft(i)} aria-label="Remover rascunho"><span className="material-symbols-outlined text-[18px]">delete</span></button>
                </td>
              </tr>
            ))}
                ...
                <tr key={lisp.id} className="border-b border-[#262626] hover:bg-[#1a1c1c] transition-colors group">
                  ...
                  <td className="py-4 pr-4 text-right">
                    <div className="flex justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                      <button className="w-8 h-8 flex items-center justify-center rounded border border-[#262626] text-on-secondary-container hover:text-white hover:border-primary-container transition-colors" onClick={() => handleEditClick(lisp)} title="Editar" aria-label="Editar"><span className="material-symbols-outlined text-[16px]">edit</span></button>
                      <button className="w-8 h-8 flex items-center justify-center rounded border border-[#262626] text-on-secondary-container hover:text-error hover:border-error/50 transition-colors" onClick={() => handleDeleteLisp(lisp)} title="Excluir" aria-label="Excluir"><span className="material-symbols-outlined text-[16px]">delete</span></button>
                    </div>
                  </td>
                </tr>
              );
