...
export default function FavoritesManager() {
  ...
  const groupedFavorites = useMemo(
    () =>
      filteredFavorites.reduce((acc, item) => {
            ...
            <div style={{ flex: "1 1 60%" }}>
              ...
              <div className="flex flex-col gap-10">
                {Object.keys(groupedFavorites)
                  ...
                  .map((category) => (
                    <div key={category}>
                      <h3 className="text-lg font-bold text-white mb-4 border-b border-[#333] pb-2">
                        {category}
                      </h3>
                      <div
                        style={{
                        ...
                        {groupedFavorites[category].map((item) => {
                          ...
                          return (
                            <div
                              ...
                              className={`${isSelected ? "border-primary-container bg-primary-container/10" : ""}`}
                              onMouseEnter={(e) => {
                                if (!isSelected)
                            ...
                            >
                                    ...
                                    {(() => {
                                      const arch = ARCHETYPES.find(
                                        (a) =>
                                          ...
                                          (a.iconUrl &&
                                            a.iconUrl === item.iconUrl),
                                      ) || {
                                        id: item.id || "f",
                                        iconUrl:
                                          item.iconUrl || "/patterns/stack.svg",
                              ...
                              >
                                ...
                                >
                                  {item.description || "Recurso guardado"}
                                </div>
                              </div>
