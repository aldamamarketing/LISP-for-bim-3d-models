        ...
        <div className="flex justify-between items-center flex-wrap gap-4 mb-6">
          ...
          <div className="flex flex-wrap gap-4 items-center w-full sm:w-auto">
            ...
            <a
              ...
              className="w-full sm:w-auto bg-[#1a1c1c] text-white border border-[#262626] hover:border-primary-container hover:text-primary-container px-4 py-2 rounded text-sm transition-colors flex justify-center items-center gap-2"
            >
          ...
          <div style={{ display: "flex", gap: "30px", flexWrap: "wrap" }}>
                  ...
                  return (
                    ...
                    >
                      <button
                        ...
                        className={`cursor-pointer text-left flex-1 flex flex-col relative w-full h-full rounded outline-none focus-visible:ring-2 ${isSelected ? "focus-visible:ring-primary-container" : "focus-visible:ring-white/50"}`}
                      ...
                      >
                        ...
                        <div className="p-4 flex-1 w-full">
                          ...
                          <div className="pointer-events-none bg-[#0A0A0A] rounded border border-[#262626] overflow-hidden p-2 flex items-center justify-center min-h-[80px]">
                            ...
                            {activeTab === "icon" && (
                              <SvgPreview
                                svgString={item.svgCode || item.code}
                              />
                            )}
                          </div>
                        </div>
                      ...
                      <div className="p-3 border-t border-[#262626] flex justify-end relative z-10">
                        <button
                          type="button"
                          onClick={(e) => {
                            e.stopPropagation();
                          ...
                          title="Apagar"
                          aria-label={`Apagar favorito ${item.name}`}
                        >
                          <span
            ...
            >
              ...
              >
                ...
                >
                  💡{" "}
                  <strong style={{ color: "var(--tmd-orange)" }}>
                    Dica Pro:
                  </strong>{" "}
                  Com o{" "}
                  <a
                    href="/dashboard"
                    style={{ color: "#f26d21", textDecoration: "underline" }}
                  >
                    Loader instalado
                  </a>
                  , seus favoritos ficam disponíveis direto na paleta do AutoCAD
