          ...
          <div className="space-y-3">
            {draftFiles.map((draft, i) => (
              <div key={i} className="flex items-start justify-between bg-surface p-3 rounded border border-outline-variant">
                ...
                <button className="text-error hover:text-white focus-visible:ring-2 focus-visible:outline-none" onClick={() => removeDraft(i)} aria-label="Excluir rascunho">
        ...
        <div className="fixed inset-0 z-[100] bg-black/80 flex items-center justify-center p-4">
          <div className="bg-[#141414] border border-[#262626] rounded-xl w-full max-w-[600px] p-6 shadow-2xl">
            <h3 className="mt-0 mb-4 text-xl flex justify-between items-center">
              ...
              <button className="text-on-surface-variant hover:text-white focus-visible:ring-2 focus-visible:outline-none" onClick={() => setShowGalleryModal(false)} aria-label="Fechar"><span className="material-symbols-outlined text-[20px]">close</span></button>
            </h3>
        ...
        <div className="fixed inset-0 z-[100] bg-black/80 flex items-center justify-center p-4">
          <div className="bg-[#141414] border border-[#262626] rounded-xl w-full max-w-[600px] p-6 shadow-2xl">
            <h3 className="mt-0 mb-4 text-xl flex justify-between items-center">
              ...
              <button className="text-on-surface-variant hover:text-white focus-visible:ring-2 focus-visible:outline-none" onClick={() => setShowFavoritesModal(false)} aria-label="Fechar"><span className="material-symbols-outlined text-[20px]">close</span></button>
            </h3>
            <div className="h-64 flex items-center justify-center border border-dashed border-[#262626] rounded text-on-surface-variant text-sm">
