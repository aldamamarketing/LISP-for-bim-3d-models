            ...
            <tr key={'draft-'+i} className="border-b border-[#262626] bg-primary-container/5 hover:bg-[#1a1c1c] transition-colors group">
              <td className="py-4 pl-4">
                <div className="flex gap-2 items-center">
                  ...
                  <button className="text-on-secondary-container hover:text-primary transition-colors focus-visible:ring-2 focus-visible:outline-none" onClick={() => document.getElementById(`svg-upload-draft-${i}`).click()} title="Upload SVG" aria-label="Upload SVG"><span className="material-symbols-outlined text-[18px]">folder_open</span></button>
                </div>
              ...
              <td className="py-4 pr-4 text-right">
                ...
                <button className="text-on-secondary-container hover:text-error transition-colors focus-visible:ring-2 focus-visible:outline-none" onClick={() => removeDraft(i)} aria-label="Excluir"><span className="material-symbols-outlined text-[18px]">delete</span></button>
              </td>
            </tr>
          ))}
                ...
                <tr key={lisp.id} className="border-b border-[#262626] bg-white/5 hover:bg-[#1a1c1c] transition-colors group">
                  <td className="py-4 pl-4">
                    <div className="flex gap-2 items-center">
                      ...
                      <button className="text-on-secondary-container hover:text-primary transition-colors focus-visible:ring-2 focus-visible:outline-none" onClick={() => document.getElementById(`svg-upload-edit-${lisp.id}`).click()} title="Upload SVG" aria-label="Upload SVG"><span className="material-symbols-outlined text-[18px]">folder_open</span></button>
                    </div>
              ...
              <tr key={lisp.id} className="border-b border-[#262626] hover:bg-[#1a1c1c] transition-colors group">
                ...
                <td className="py-4 pr-4 text-right">
                  <div className="flex justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                    <button className="w-8 h-8 flex items-center justify-center rounded border border-[#262626] text-on-secondary-container hover:text-white hover:border-primary-container transition-colors focus-visible:ring-2 focus-visible:outline-none" onClick={() => handleEditClick(lisp)} title="Editar" aria-label="Editar"><span className="material-symbols-outlined text-[16px]">edit</span></button>
                    <button className="w-8 h-8 flex items-center justify-center rounded border border-[#262626] text-on-secondary-container hover:text-error hover:border-error/50 transition-colors focus-visible:ring-2 focus-visible:outline-none" onClick={() => handleDeleteLisp(lisp)} title="Excluir" aria-label="Excluir"><span className="material-symbols-outlined text-[16px]">delete</span></button>
                  </div>
                </td>
              </tr>
            );
